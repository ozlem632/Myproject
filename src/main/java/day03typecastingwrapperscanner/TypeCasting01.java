...
public class TypeCasting01{
    ...
    //Note:1: Kucuk data type'ini buyuk data type'ina cevirmeye "Auto Widening"denir
    //Note:2: Buyuk data type'ini kucuk data type'ina cevirmeye "Explit Narrowing" denir
