...
public class DateTime02 {
    public static void main(String[] args) {
        ...
        DateTimeFormatter dtf2 = DateTimeFormatter.ofPattern("MMM/dd/yyyy");// formattter metodu ile tarihin formatini degistiriyoruz
        //amerikan format gore once ay sonra gun
        String formattedDate2 = dtf2.format(currentDate);//3 m olursa kisaltir ay ismini
        System.out.println(formattedDate2);// Oct/21/2022

        DateTimeFormatter dtf3 = DateTimeFormatter.ofPattern("MMMM/dd/yyyy");//4 tane m koyarsaniz ay ismini tam verir veyazi ile
        ...
        String formattedDate4= dtf4.format(currentDate);// tek m olursa aylari sadece rakami yazar 2 mm de 03 diye yazar
        System.out.println(formattedDate4);//10/21/2022

        DateTimeFormatter dtf5 = DateTimeFormatter.ofPattern("MM/dd/yy");// 2 noktayi soru isaretini bile kabul eder
        ...
        DateTimeFormatter dtf8 = DateTimeFormatter.ofPattern("hh:mm a");// kucuk a yazinca pm koyar
