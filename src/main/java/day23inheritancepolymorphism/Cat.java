...
public class Cat extends Mammal {
    ...
    @Override//@override annotationini kullanarak javanin yaptigimiz ovverride islemini kontrol etmesini saglar
    //annotation  birsey arrabo ile kullanilirsa denir
    public void eat() {//parantezin icin parametre konursa sikayet eder
    ...
    @Override
    public Integer multiply(int a, int b) {//integeri short yapamayizcunku b irbirinin parenti degil
        return a*b+1;
    }
