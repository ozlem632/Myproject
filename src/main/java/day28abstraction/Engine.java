...
public interface Engine {
    ...
    */
    ...
    //"public abstract void eco();" ile "void eco();" ayni anlama gelir//interfacedeki metodlar body konulamaz
    void eco();
    ...
    //Asagidaki non-static method'dur.Objelere yapistirilir .ulasmak icin obje kullanilirConcrit metod uretmek icin.

    public default int add(int a, int b){
        return a+b;
    }
    //static keyword kullanarak interfacenin icinde bodysi olan metodlar uretebilirsiniz.concrit metod icin
    //asagidaki methos static metoddur .Static metod clasa yapistirilir .Clas ismi ile ulasabiliriz
