...
public class Civic implements Engine, Ac {
    ...
    @Override
    public void run() {// iki parentli class olmaz cunku metodun bodysi problem olur javanin kafasi karisir.fakat interface de body olm icin
        //child clasin kafasi karismaz
